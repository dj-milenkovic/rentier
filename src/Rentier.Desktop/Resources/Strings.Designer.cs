...
public static class Strings
{
    ...
    public static string ManualFiling_Title => "New Filing";
    public static string ManualFiling_IncomeType_Label => "Income Type";
    public static string ManualFiling_Ticker_Label => "Ticker / Asset";
    public static string ManualFiling_IncomeDate_Label => "Income Date";
    ...
    public static string ManualFiling_Preview_Title => "Filing Preview";
    public static string ManualFiling_Preview_GrossIncome => "Gross Income";
    public static string ManualFiling_Preview_WhtPaid => "WHT Paid";
    public static string ManualFiling_Preview_GrossTax => "Gross Tax Payable";
    public static string ManualFiling_Preview_TaxPayable => "Tax Payable";
    public static string ManualFiling_Preview_Deadline => "Filing Deadline";
    public static string ManualFiling_Preview_ExchangeRate => "Exchange Rate";
    public static string ManualFiling_Preview_RateSource => "Rate Source";
    public static string ManualFiling_Error_TickerRequired => "Ticker is required";
    public static string ManualFiling_Error_GrossRequired => "Gross amount must be greater than zero";
    public static string ManualFiling_Error_DateRequired => "Income date is required";
    public static string ManualFiling_Error_NetExceedsGross => "Net received cannot exceed gross amount";
    public static string ManualFiling_Error_RateNotFound => "Exchange rate not available for {0} on {1}";
    public static string ManualFiling_Error_DuplicateFiling => "A filing with the same details already exists";
    public static string ManualFiling_Error_NoProfile => "Please configure your taxpayer profile in Settings before creating a filing";
    public static string ManualFiling_Error_NetworkFailure => "Could not reach NBS exchange rate service. Please check your connection.";
    public static string ManualFiling_IncomeType_Dividend => "Dividend";
