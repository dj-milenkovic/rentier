        ...
        var doc = new XDocument(
            ...
            new XElement(Ns1 + "PodaciPoreskeDeklaracije",
                ...
                new XElement(Ns1 + "PodaciOPoreskomObvezniku",
                    new XElement(Ns1 + "PoreskiIdentifikacioniBroj", profile.Jmbg),
                    new XElement(Ns1 + "ImePrezimeObveznika", new XCData(" " + profile.FullName + " ")),
                    new XElement(Ns1 + "UlicaBrojPoreskogObveznika", new XCData(" " + profile.Address + " ")),
                ...
                new XElement(Ns1 + "DeklarisaniPodaciOVrstamaPrihoda",
                ...
                new XElement(Ns1 + "Ukupno",
                    new XElement(Ns1 + "FondSati", "0.00"),
                    new XElement(Ns1 + "BrutoPrihod", Fmt(filing.GrossIncomeRsd)),
                    new XElement(Ns1 + "OsnovicaZaPorez", Fmt(filing.GrossIncomeRsd)),
                    new XElement(Ns1 + "ObracunatiPorez", Fmt(filing.GrossTaxPayableRsd)),
                    new XElement(Ns1 + "PorezPlacenDrugojDrzavi", Fmt(filing.WhtPaidRsd)),
                    ...
                    new XElement(Ns1 + "PIO", "0.00"),
                    new XElement(Ns1 + "ZDRAVSTVO", "0.00"),
                    new XElement(Ns1 + "NEZAPOSLENOST", "0.00")),
