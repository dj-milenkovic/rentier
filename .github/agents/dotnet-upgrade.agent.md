...
name: '.NET Upgrade'
tools: ['search/codebase', 'edit/editFiles', 'search', 'vscode/runCommand', 'execute/createAndRunTask', 'execute/runTests', 'read/problems', 'search/changes', 'search/usages', 'execute/testFailure', 'read/terminalLastCommand', 'read/terminalSelection', 'web/fetch']
---
